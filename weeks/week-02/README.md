...
3. Finish Green Book Chapter 2 (remaining sections)
...
- [ ] [Intro to Sorting](https://usaco.guide/bronze/intro-sorting)
- [ ] [Intro to Sets & Maps](https://usaco.guide/bronze/intro-sets)
- [ ] [Casework](https://usaco.guide/bronze/casework)
- [ ] [Intro to Greedy Algorithms](https://usaco.guide/bronze/intro-greedy)
- [ ] [Intro to Graphs](https://usaco.guide/bronze/intro-graphs)
- [ ] [Rectangle Geometry](https://usaco.guide/bronze/rect-geo)
...
- [ ] **2.8 Math Induction:** Coin split problem, Chocolate bar problem, Race track
- [ ] **2.9 Proof by Contradiction:** Irrational number, Rainbow hats
...
- [ ] 11 CSES Sorting & Searching problems solved
- [ ] 19 Green Book problems attempted (2.4–2.9)
- [ ] Green Book Chapter 2 fully completed
- [ ] PROGRESS.md updated
