...
| Metric | Count |
|--------|-------|
| Current streak (consecutive days) | 0 |
| Longest streak | 0 |
| Total study days | 0 / 54 |
| Green Book problems solved | 0 / 104 |
| USACO modules completed | 0 / 46 |
| CSES problems solved | 0 / 145 |
| Mock tests taken | 0 |
...
- [ ] USACO General: Data Types
- [ ] USACO General: Input & Output
- [ ] USACO General: Expected Knowledge
- [ ] USACO General: How to Debug
- [ ] USACO General: How to Practice
- [ ] USACO General: Fast I/O
- [ ] USACO General: Basic Debugging
- [ ] USACO General: C++ With the Command Line
- [ ] USACO Bronze: Time Complexity
- [ ] USACO Bronze: Intro to Data Structures
- [ ] USACO Bronze: Simulation
- [ ] CSES Introductory: Weird Algorithm → Palindrome Reorder (first 12)
- [ ] Green Book 2.1: Screwy pirates, Tiger and sheep
...
- [ ] USACO Bronze: Intro to Sets & Maps
- [ ] USACO Bronze: Casework
- [ ] USACO Bronze: Intro to Greedy Algorithms
- [ ] USACO Bronze: Intro to Graphs
- [ ] USACO Bronze: Rectangle Geometry
- [ ] USACO Bronze: Ad Hoc Problems
- [ ] CSES Introductory: Gray Code → Grid Path Description (remaining 12)
- [ ] CSES Sorting: Distinct Numbers → Collecting Numbers (first 11)
- [ ] Green Book 2.4: Coin piles, Mislabeled bags, Wise men
- [ ] Green Book 2.5: Clock pieces, Missing integers, Counterfeit coins I
- [ ] Green Book 2.6: Matching socks, Handshakes, Have we met before?, Ants on a square, Counterfeit coins II
- [ ] Green Book 2.7: Prisoner problem, Division by 9, Chameleon colors
...
- [ ] USACO Silver: Binary Search on Sorted Array
- [ ] USACO Silver: Binary Search
- [ ] USACO Silver: Custom Comparators & Coordinate Compression
- [ ] USACO Silver: Greedy Algorithms with Sorting
- [ ] CSES Sorting: Collecting Numbers II → Room Allocation (next 12)
- [ ] CSES Sorting: Factory Machines → Maximum Subarray Sum II (remaining 12)
...
- [ ] USACO Silver: Intro to Tree Algorithms
- [ ] USACO Silver: Intro to Functional Graphs
- [ ] USACO Silver: Intro to Bitwise Operators
- [ ] CSES DP: Dice Combinations → Grid Paths I (first 6)
- [ ] CSES DP: Book Shop → Counting Towers (next 3)
- [ ] CSES DP: Edit Distance → Minimal Grid Path (next 3)
...
- [ ] USACO Gold DP: Introduction to DP
- [ ] USACO Gold DP: Knapsack DP
- [ ] USACO Gold DP: Paths on Grids
- [ ] CSES DP: Money Sums → Mountain Range (next 4)
- [ ] CSES DP: Increasing Subsequence → Increasing Subsequence II (remaining 6)
- [ ] Green Book 4.4: Meeting probability, Probability of triangle, Property of Poisson process, Moments of normal distribution
...
- [ ] USACO Gold DP: Digit DP
- [ ] CSES Math: Josephus Queries → Next Prime (first 10)
- [ ] CSES Math: Binomial Coefficients → Counting Grids (next 10)
- [ ] Green Book 5.1: Gambler's ruin problem, Dice question, Coin triplets, Color balls
...
- [ ] CSES Additional (math): K Subset Sums I, K Subset Sums II, GCD Subsets, School Excursion
- [ ] Green Book 7.1: Number swap, Unique elements, Horner's algorithm, Moving average, Sorting algorithm, Random permutation, Search algorithm, Fibonacci numbers, Maximum contiguous subarray
- [ ] Green Book 7.2: Power of 2?, Multiplication by 7, Probability simulation, Poisonous wine
